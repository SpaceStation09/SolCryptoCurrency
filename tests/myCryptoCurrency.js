...
describe('myCryptoCurrency', () => {
  const provider = anchor.Provider.local();

  anchor.setProvider(provider);

  const program = anchor.workspace.MyCryptoCurrency;
...
//console.log(typeof TokenInstructions.TOKEN_PROGRAM_ID)
const TOKEN_RPOGRAM_ID = TokenInstructions.TOKEN_PROGRAM_ID;
