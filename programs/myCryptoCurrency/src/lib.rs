...
declare_id!("AmgL3kMfYWhF5PA9fZgAYycB8tWBim7zyrwVZ16NujGS");

#[program]
pub mod my_crypto_currency {
    use super::*;
    // Context is always the first parameter of a function in on-chain program
    // Context consists of the solana accounts array and the program ID.
